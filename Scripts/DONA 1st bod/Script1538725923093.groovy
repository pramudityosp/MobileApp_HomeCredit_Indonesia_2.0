...
Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView4 - LANJUTKAN (1)'), 5)
...
Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView0 - GANTI KAMERA (1)'), 3)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.ImageView10'), 5)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.ImageView2'), 5)

Mobile.delay(8, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView2 - LANJUTKAN'), 3)
...
Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView15 - LANJUTKAN'), 3)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.ImageButton1 (2)'), 3)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView2 - LANJUTKAN (1)'), 3)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView1 - MULAI PENGAJUAN'), 3)

Mobile.setText(findTestObject('My Home Credit Indonesia/DONA/android.widget.EditText0'), '0108501701931115', 3)

Mobile.setText(findTestObject('My Home Credit Indonesia/DONA/android.widget.EditText1'), 'DONNNSA LAGXGYIS', 3)

Mobile.setText(findTestObject('My Home Credit Indonesia/DONA/android.widget.EditText2'), 'DOUNATSSS', 3)

Mobile.setText(findTestObject('My Home Credit Indonesia/DONA/android.widget.EditText3'), 'Jakarta', 3)

Mobile.scrollToText('LANJUT ISI KONTAK', FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('My Home Credit Indonesia/DONA/android.widget.EditText1 (1)'), 'MOZZZZMMMYY DONAT', 3)
...
Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.LinearLayout23'), 0)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView5 - Aceh Selatan'), 3)

Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.LinearLayout24'), 0)
...
Mobile.tap(findTestObject('My Home Credit Indonesia/DONA/android.widget.TextView1 - Selesai'), 5)
